...
def load_data(config):
    ...
    df = pd.read_csv('/home/lthoma21/BFE-Loss-Function/FINAL-PDBBIND-FILES/Datasets/pdbbind_300.csv')
    PDBs = pickle.load(open('/home/lthoma21/BFE-Loss-Function/FINAL-PDBBIND-FILES/Datasets/PDBBind_300.pkl', 'rb'))
...
def main():
    ...
    for physics_weight in physics_hyperparam:
        ...
        early_stopping = EarlyStopping(
            monitor='loss',
            patience=20,  # Wait 20 epochs before stopping (good for 100+ structures)
